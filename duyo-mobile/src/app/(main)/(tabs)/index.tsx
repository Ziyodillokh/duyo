...
const ACTION_CARDS = [
  {
    ...
    colors: ['#C27AFF', '#FB64B6'] as readonly [string, string],
    href: '/(main)/(tabs)/chat',
  },
  {
    key: 'poem',
    emoji: '📚',
    label: "She'r o'qish",
    colors: ['#51A2FF', '#00D3F3'] as readonly [string, string],
  ...
  },
  {
    ...
    colors: ['#05DF72', '#00D492'] as readonly [string, string],
    href: '/(main)/(tabs)/library',
  },
  {
    key: 'game',
    emoji: '🎮',
    label: "O'yinlar",
    colors: ['#FF8904', '#FF6467'] as readonly [string, string],
    ...
    <ScreenDark>
      ...
      >
        ...
        <DarkCard glow="green">
          ...
          <View className="mt-4 bg-neon-green rounded-md h-16 items-center justify-center">
        ...
        <View className="flex-row flex-wrap gap-3">
          {ACTION_CARDS.map((card) => (
            ...
            >
              <LinearGradient
                colors={card.colors as unknown as readonly [string, string]}
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 1 }}
                style={{
                  padding: 24,
