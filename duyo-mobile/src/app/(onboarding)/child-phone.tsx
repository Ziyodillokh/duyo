...
//  * border on the `TextInput` would sit inside the pane's rounded edge and
//  * read as a second box, and the web input's own outline is suppressed below
//  * so the pane is the only thing that lights up.
//  */
...
//
//             {/* The one hero object on the screen, so it sits a rung above
//                 the chip and the field it contains. */}
...
//                 {t('onboarding.childPhone.helper')}
//               </Text>
//             </View>
//           </View>
//         </KeyboardAwareScrollView>
...
//
//   // Solid rather than glass: the card's one action should not read as
//   // another frosted pane stacked on the pane it sits in.
//   cta: {
//     width: '100%',
//     height: 56,
//     marginTop: 24,
