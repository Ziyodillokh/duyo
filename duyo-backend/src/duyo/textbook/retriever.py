...
def build_rag_context(chunks_with_scores: list[tuple[TextbookChunk, float]]) -> str | None:
    ...
    lines.append(
        ...
        "ma'lumotni olib, o'z so'zing bilan javob ber. "
        "Javobni MAJBURIY ravishda sinf va mavzu bilan boshla — kontekstdagi "
        "\"Sinf\" va \"Mavzu\" qiymatlaridan foydalanib, masalan: "
        "\"6-sinf, Fotosintez mavzusiga ko'ra, ...\". Agar Mavzu ko'rsatilmagan "
        "bo'lsa, sinf va fan bilan boshla (\"6-sinf Botanika darsligiga ko'ra, "
        "...\"). "
        "Agar savol yil yoki sana so'rasa, ANIQ yil/sanani ayt — mavhum yoki "
        "taxminiy javob berma. "
