...
INSIGHT_EXTRACT_PROMPT = (
    ...
    "- length_pref: FAQAT bola javob uzunligini O'ZI so'ragan bo'lsa yoz — "
    "\"qisqaroq ayt\", \"uzundan tushuntir\" kabi. Bolaning xabari qancha "
    "uzunligiga QARAMA: \"fotosintez nima?\" uch so'z, lekin qisqa javob "
    "so'ramaydi. Aniq so'ralmagan bo'lsa null.\n"
