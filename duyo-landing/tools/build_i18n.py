...
T = [
    ...
    ("Ikkita reja:",
     "Два плана: бесплатный, чтобы попробовать, и одна полная подписка — отменить можно в любой момент",
     "Two plans: a free one to try it out and a single full subscription — cancel at any time"),
    ...
    ("Kuniga 20 xabar", "20 сообщений в день", "20 messages a day"),
    ("Tayyor javoblar", "Готовые ответы — без AI-общения", "Scripted replies — no AI chat"),
    ("Cheklangan kutubxona", "Ограниченная библиотека", "Limited library"),
    ("Boshlash", "Начать", "Get started"),
    ("Yagona obuna", "Единственная подписка", "The only subscription"),
    ("Hamroh", "Спутник", "Companion"),
    ("Ovoz, uchta til",
     "Голос, три языка и вся библиотека — всё в одном плане",
     "Voice, three languages and the whole library — all in one plan"),
    ("/oy", "/мес", "/mo"),
    ("300 000", "или 300 000 сум/год — 2 месяца в подарок", "or 300,000 UZS/year — 2 months free"),
    ("Kuniga 100 xabar", "100 сообщений в день", "100 messages a day"),
    ("Ovozli suhbat", "Голосовое общение", "Voice chat"),
    ("3 til (o", "3 языка (узбекский, русский, английский)", "3 languages (Uzbek, Russian, English)"),
    ("^To'liq kutubxona", "Полная библиотека", "The full library"),
    ...
    ("bepul boshlash mumkin",
     "Да, DUYO можно начать бесплатно. На бесплатном плане — 20 сообщений в день, один язык и часть библиотеки. Для 100 сообщений в день, голосового общения, трёх языков и всей библиотеки есть одна подписка — «Спутник», 30 000 сум в месяц.",
     "Yes — you can start DUYO free. The free plan gives you 20 messages a day, one language and part of the library. For 100 messages a day, voice chat, three languages and the whole library there is a single subscription — “Companion”, 30,000 UZS a month."),
    ...
    ("ilovaning o'zidan bekor qilasiz",
     "Подписку можно отменить в любой момент — отмените прямо в приложении: Настройки → Подписка → Отменить подписку. Все возможности сохраняются до конца оплаченного периода.",
     "You can cancel any time — cancel right in the app: Settings → Subscription → Cancel subscription. Everything stays available until the end of the paid period."),
    ("Javobini topa",
    ...
    ("Boshlash bepul",
     "Начать бесплатно, регистрация проста",
     "Free to start, signing up is simple"),
