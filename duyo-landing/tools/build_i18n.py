...
T = [
    ...
    ("bekor qilishingiz mumkin",
     "Подписку можно отменить в любой момент — напишите на support@duyo.uz. Все возможности сохраняются до конца оплаченного периода.",
     "You can cancel any time — write to support@duyo.uz. Everything stays available until the end of the paid period."),
    ("Javobini topa",
