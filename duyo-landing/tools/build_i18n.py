...
T = [
    ...
    ("bekor qilishingiz mumkin",
     "Подписку можно отменить в любой момент — напишите на duyosupport@gmail.com. Все возможности сохраняются до конца оплаченного периода.",
     "You can cancel any time — write to duyosupport@gmail.com. Everything stays available until the end of the paid period."),
    ("Javobini topa",
